...
var BMIcal = async function (user_account) {
    ...
    //讀取資料表
    await query('SELECT a.user_account, a.height, a.weight, a.infono, b.actno FROM project.information a, project.user b WHERE a.user_account = $1 and a.user_account = b.user_account order by a.infono desc', [user_account])
        .then((data) => {
